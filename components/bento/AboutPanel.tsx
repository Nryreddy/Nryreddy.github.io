    ...
    <Panel className="flex flex-col p-3 md:p-4 bg-[#111116] border-none shadow-2xl relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-2">
        ...
        <div className="bg-[#0d0d10] rounded-lg border border-white/5 p-3 shadow-inner">
          {/* Prompt line */}
          <p className="text-[#fbbd23] text-[12px] font-bold mb-1.5 tracking-wider" style={retroFont}>
            <span className="opacity-60">$&gt;</span> bio --verbose
          </p>

          {/* Bio body — merged to 2 tight lines */}
          <p className="text-white/80 text-sm leading-relaxed tracking-wide" style={retroFont}>
            I build AI that actually does stuff — <span className="text-white font-bold">not just demos</span>.
            LLM agents, voice assistants, <span className="text-white font-bold">openclaw</span>, surveillance alerts in seconds.
            Fresh out of a <span className="text-[#fbbd23] font-bold">Master of AI</span> from Monash University AUS,
            shipping pipelines on AWS &amp; Azure and agentic workflows from scratch.
          </p>
          <p className="text-white/80 text-sm leading-relaxed tracking-wide mt-2" style={retroFont}>
            I care about real-world impact, reliable deploys, AI that holds up in prod.
            <span className="inline-block w-2 h-3.5 bg-[#fbbd23] ml-1.5 align-middle animate-pulse" />
          </p>
        </div>
      </div>
    </Panel>
